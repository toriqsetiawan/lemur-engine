...
@if( !empty($section) && !empty($section->slug) )
    ...
    <div class="form-group col-lg-6 col-md-6 col-sm-12" data-test="slug_div">
        ...
        {!! Form::text('slug', null, ['class' => 'form-control', 'id'=>"slug_field", 'readonly'=>'readonly', App\Models\section::getFormValidation('slug'), 'data-test'=>"slug_field"]) !!}
    </div>
    <div class="clearfix"></div>
...
<div class="form-group col-lg-6 col-md-6 col-sm-12" data-test="name_div">
    ...
    {!! Form::text('name', null, ['class' => 'form-control', App\Models\section::getFormValidation('name'),'id'=>"name_field", 'data-test'=>"name_field"] ) !!}
</div>
<div class="clearfix"></div>
...
<div class="form-group col-lg-6 col-md-6 col-sm-12" data-test="order_div">
    ...
    {!! Form::number('order', null, ['rows' => 2, 'class' => 'form-control', 'id'=>"order_field", 'data-test'=>"order_field", App\Models\Section::getFormValidation('order')] ) !!}
</div>
...
<div class="form-group col-lg-6 col-md-6 col-sm-12 select2" data-test="status_div">
    ...
    {!! Form::select('type', config('lemur_dropdown.sections'), null, [ 'class' => 'form-control select2 first-option', App\Models\Section::getFormValidation('type'), 'data-test'=>"$htmlTag-type-select", 'id'=>"$htmlTag-type-select"]) !!}
</div>
<div class="clearfix"></div>
<!-- Default State Field -->
<div class="form-group col-lg-6 col-md-6 col-sm-12 select2" data-test="section_state_div">
    ...
    {!! Form::select('default_state', config('lemur_dropdown.default_state'), null, [ 'class' => 'form-control select2 first-option', App\Models\Section::getFormValidation('default_state'), 'data-test'=>"$htmlTag-default-state-select", 'id'=>"$htmlTag-default-state-select"]) !!}
</div>
