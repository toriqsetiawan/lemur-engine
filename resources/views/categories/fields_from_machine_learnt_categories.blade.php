...
<div class="form-group col-lg-6 col-md-6 col-sm-12" data-test="pattern_div">
    ...
    {!! Form::text('pattern', $machineLearntCategory->pattern, ['class' => 'form-control', App\Models\Category::getFormValidation('pattern'),'id'=>"pattern_field", 'data-test'=>"pattern_field"] ) !!}
...
<div class="form-group col-lg-6 col-md-6 col-sm-12" data-test="template_div">
    ...
    {!! Form::textarea('template', $machineLearntCategory->template, ['rows' => 10, 'class' => 'form-control', 'id'=>"template_field", 'data-test'=>"template_field", App\Models\Category::getFormValidation('template')] ) !!}
