...
<div class="form-group col-lg-6 col-md-6 col-sm-12" data-test="title_div">
    ...
    {!! Form::text('title', null, ['class' => 'form-control','maxlength' => 255,'maxlength' => 255, App\Models\BotKey::getFormValidation('name'),'id'=>"title_field", 'data-test'=>"title_field"] ) !!}
</div>
...
<div class="form-group col-lg-6 col-md-6 col-sm-12" data-test="body_div">
    ...
    {!! Form::textarea('body', null, ['rows'=>3, 'class' => 'form-control','maxlength' => 100,'maxlength' => 100, App\Models\BotKey::getFormValidation('body'),'id'=>"body_field", 'data-test'=>"body_field"] ) !!}
</div>
