...
@if( !empty($botAllowedSite) && !empty($botAllowedSite->slug) )
    ...
    <div class="form-group col-lg-6 col-md-6 col-sm-12" data-test="slug_div">
        ...
        {!! Form::text('slug', null, ['class' => 'form-control', 'id'=>"slug_field", 'readonly'=>'readonly', App\Models\BotAllowedSite::getFormValidation('slug'), 'data-test'=>"slug_field"]) !!}
    </div>
    <div class="clearfix"></div>
...
@elseif(!empty($botAllowedSite) && !empty($botAllowedSite->bot))
    ...
    <div class="form-group col-lg-6 col-md-6 col-sm-12" data-test="bot_slug_div">
        ...
        <div class="input-group">
            {!! Form::text('', $botAllowedSite->bot->name.' ('.$botAllowedSite->bot->slug.')', ['disabled'=>'disabled', 'readonly'=>'readonly','class' => 'form-control', 'id'=>"bot_slug_field", 'data-test'=>"bot_slug_field", App\Models\BotAllowedSite::getFormValidation('bot_id')]) !!}
...
@else
    ...
    <div class="form-group col-lg-6 col-md-6 col-sm-12 select2" data-test="bot_id_div">
        ...
        {!! Form::select('bot_id', $botList, (!empty($botAllowedSite)?$botAllowedSite->bot->slug:(!empty($botAllowedSite)?$botAllowedSite->bot->slug:"")), [  'placeholder'=>'Please Select', 'class' => 'form-control select2 generic', App\Models\BotAllowedSite::getFormValidation('bot_id'), 'data-test'=>"$htmlTag-bot_id-select", 'id'=>"$htmlTag-bot_id-select"]) !!}
    </div>
...
<div class="form-group col-lg-6 col-md-6 col-sm-12" data-test="website_url_div">
    ...
    {!! Form::text('website_url', null, ['class' => 'form-control','maxlength' => 255,'maxlength' => 255, App\Models\BotAllowedSite::getFormValidation('website_url'),'id'=>"website_url_field", 'data-test'=>"website_url_field", 'placeholder'=>"https://www.example.com"] ) !!}
</div>
