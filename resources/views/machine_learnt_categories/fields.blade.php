...
@if( !empty($machineLearntCategory) && !empty($machineLearntCategory->slug) )
    ...
    <div class="form-group col-sm-6" data-test="slug_div">
        ...
        {!! Form::text('slug', null, ['class' => 'form-control', 'id'=>"slug_field", 'readonly'=>'readonly', App\Models\MachineLearntCategory::getFormValidation('slug'), 'data-test'=>"slug_field"]) !!}
    </div>
...
<div class="form-group col-lg-6 col-md-6 col-sm-12" data-test="client_id_div">
    ...
    <div class="input-group">
        {!! Form::text('client_id', $machineLearntCategory->client->slug, ['readonly'=>'readonly', 'class' => 'form-control', 'id'=>"client_id_field", 'data-test'=>"client_id_field", App\Models\Conversation::getFormValidation('client_id')]) !!}
...
<div class="form-group col-lg-6 col-md-6 col-sm-12" data-test="category_group_id_div">
    ...
    <div class="input-group">
        {!! Form::text('', $machineLearntCategory->bot->name.' ('.$machineLearntCategory->bot->slug.')', ['disabled'=>'disabled', 'readonly'=>'readonly','class' => 'form-control', 'id'=>"bot_slug_field", 'data-test'=>"bot_slug_field", App\Models\SetValue::getFormValidation('bot_id')]) !!}
        <div class="input-group-btn">
...
<div class="form-group col-lg-6 col-md-6 col-sm-12" data-test="turn_id_div">
    ...
    <div class="input-group">
        {!! Form::text('turn_id', $machineLearntCategory->turn->slug, ['readonly'=>'readonly','class' => 'form-control', 'id'=>"turn_id_field", 'data-test'=>"turn_id_field", App\Models\SetValue::getFormValidation('turn_id')]) !!}
        <div class="input-group-btn">
...
<div class="form-group col-lg-6 col-md-6 col-sm-12" data-test="pattern_div">
    ...
    {!! Form::text('pattern', null, ['class' => 'form-control', App\Models\MachineLearntCategory::getFormValidation('pattern'),'id'=>"pattern_field", 'data-test'=>"pattern_field"] ) !!}
</div>
...
<div class="form-group col-lg-6 col-md-6 col-sm-12" data-test="template_div">
    ...
    {!! Form::textarea('template', null, ['rows' => 2, 'class' => 'form-control', 'id'=>"template_field", 'data-test'=>"template_field", App\Models\MachineLearntCategory::getFormValidation('template')] ) !!}
</div>
...
<div class="form-group col-lg-6 col-md-6 col-sm-12" data-test="topic_div">
    ...
    {!! Form::text('topic', null, ['class' => 'form-control', App\Models\MachineLearntCategory::getFormValidation('topic'),'id'=>"topic_field", 'data-test'=>"topic_field"] ) !!}
</div>
...
<div class="form-group col-lg-6 col-md-6 col-sm-12" data-test="that_div">
    ...
    {!! Form::text('that', null, ['class' => 'form-control', App\Models\MachineLearntCategory::getFormValidation('that'),'id'=>"that_field", 'data-test'=>"that_field"] ) !!}
</div>
...
<div class="form-group col-lg-6 col-md-6 col-sm-12" data-test="example_input_div">
    ...
    {!! Form::textarea('example_input', null, ['rows' => 2, 'class' => 'form-control', 'id'=>"example_input_field", 'data-test'=>"example_input_field", App\Models\MachineLearntCategory::getFormValidation('example_input')] ) !!}
</div>
